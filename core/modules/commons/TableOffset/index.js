...
import TableFilters from '@common_tableoffset/components/TableFilters';
import { breakPointsUp } from '@helper_theme';
import useStyles from '@common_tableoffset/style';
...
const RenderTableFooter = ({ totalData, rowsPerPage, handlePaginationChange, page }) => {
...
const RenderTableBody = ({ checkedRows, primaryKey, singleSelection, setCheckedRows, handleChecked,
    rows, handleClickRow, showCheckbox, columns, loading }) => {
...
const RenderTablePerpage = ({ rowsPerPage, handleChangeRowsPerPage }) => {
    const classes = useStyles();
    return (
        <div size="small" className={classes.tablePerPage}>
                    ...
                    <div className={classes.tableToolbar}>
                        <div className="top-buttons-wrapper">
                            ...
                            <div className="top-item hideable">
                                ...
                                <RenderTablePerpage rowsPerPage={rowsPerPage} handleChangeRowsPerPage={handleChangeRowsPerPage} />
                            </div>
