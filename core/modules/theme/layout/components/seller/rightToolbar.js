...
import {
    PRIMARY, TABLE_GRAY, PRIMARY_DARK, GRAY_LIGHT, WHITE, GRAY_SECONDARY, BLACK, GRAY_DARK,
} from '@theme_color';
                    ...
                    {loading ? (
                        ...
                        <div>
                            ...
                            {data?.getNotificationList?.items?.map((notif, idx) => (
                                ...
                                >
                                    <div style={{ color: GRAY_SECONDARY, fontSize: 11, marginBottom: 5 }}>{notif.created_at}</div>
                                    <span style={{ color: BLACK, fontSize: 13, fontWeight: 'bold' }}>{notif.entity_type}</span>
                                    <br />
                                    <span
                                        style={{
                                            color: GRAY_DARK,
