...
const Core = (props) => {
    ...
    const pageConfig = {
        title: t('productbulktools:Fixed_Bundle_Product_Import_Tutorial'),
    };

    const [downloadList, downloadListRes] = gqlService.downloadSampleCsv({ type: 'fixed_bundle_product' });
