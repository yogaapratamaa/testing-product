...
const Core = (props) => {
    ...
    const pageConfig = {
        title: t('productbulktools:Product_Configurable_Import_Tutorial'),
    };

    const [downloadList, downloadListRes] = gqlService.downloadSampleCsv({ type: 'configurable_product' });
