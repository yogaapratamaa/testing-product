...
import useStyles from '@modules/configurationproduct/pages/default/components/style';
...
import InputText from '@modules/configurationproduct/pages/default/components/Input/inputText';
import InputSelect from '@modules/configurationproduct/pages/default/components/Input/inputSelect';
import InputFile from '@modules/configurationproduct/pages/default/components/Input/inputFile';

const ProductConfigurationContent = (props) => {
    const { formik, dataProduct, t } = props;
    ...
    return (
        <>
            <h2 className={classes.titleTop}>{t('productconfiguration:Product_Configuration')}</h2>
            <Paper className={classes.container}>
                <div className={classes.content}>
                    {dataProduct?.map((parent, index) => (
                        <Accordion
...
export default ProductConfigurationContent;
