...
const ChannelEditContent = (props) => {
    const {
        ...
        getMarketplaceDefaultShippingMethodsRes, marketplaceName, t,
    } = props;
            ...
            <Paper className={classes.container}>
                <div className={classes.content}>
                    ...
                    <div className={classes.formField}>
                        ...
                        <div className={classes.tooltip}>
                            <Tooltip
                                title={t('channel:\"One_Store_Priority_Only\"_means_allocate_to_one_store_only_if_not_available_mark_order_as_Failed__Allocation_not_found\r\n\r\n\"Split_Shipment_if_One_Store_Not_Available\"_means_allocate_to_one_store_that_can_fulfill_all_items_if_not_available_allocate_to_more_than_one_store\r\n\r\n\"Split_Shipment\"_means_order_can_be_allocate_to_more_than_one_store')}
                                placement="top"
                                arrow
                                classes={{ tooltip: classes.tooltipWidth }}
                            >
