...
import InputText from '@modules/configurationrma/pages/default/components/inputText';
import InputSelect from '@modules/configurationrma/pages/default/components/inputSelect';
import InputTable from '@modules/configurationrma/pages/default/components/inputTable';
import InputMultiSelect from '@modules/configurationrma/pages/default/components/inputMultiSelect';

const ReturnConfigContent = (props) => {
    const { formik, dataReturn, t } = props;
    ...
    return (
        <>
            <h2 className={classes.titleTop}>{t('returnconfiguration:Return_Configuration')}</h2>
            <Paper className={classes.container}>
                <div className={classes.content}>
                    {dataReturn?.map((parent, index) => (
                        <Accordion
...
export default ReturnConfigContent;
