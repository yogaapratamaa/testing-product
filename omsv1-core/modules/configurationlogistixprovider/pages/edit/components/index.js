...
import useStyles from '@modules/configurationlogistixprovider/pages/edit/components/style';
    ...
    return (
        <>
            ...
            <h2 className={classes.titleTop}>
                {`${t('logistixproviderconfiguration:Logistix_Provider_Configuration')} #${logistixDetail.entity_id}`}
            </h2>
