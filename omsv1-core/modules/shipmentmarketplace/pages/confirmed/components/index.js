...
const HomeDeliveryImport = (props) => {
    ...
    return (
        <>
            ...
            <h2 className={classes.titleTop}>{t('shipmentmarketplace:Bulk_Confirmed')}</h2>
            <Paper className={classes.container}>
                <span className={clsx(classes.textAttach, classes.label)}>{t('shipmentmarketplace:Attach_File')}</span>
                <div className={classes.content}>
                    <div className={classes.formField}>
                        <div className={classes.label}>
                            <Link href="/shipment/shipmentmarketplace/tutorialbulkconfirmed">
                                <a target="_blank" className={classes.linkDownload}>
                                    {t('shipmentmarketplace:Bulk_Confirmed_Tutorial')}
                                </a>
                            </Link>
                        </div>
                    </div>
                    <div className={classes.formField} style={{ textAlign: 'left' }}>
                        <DropFile
                            title={t('shipmentmarketplace:Please_select_the_file_')}
                            error={(
                    ...
                    ? (
                        <div className={classes.progressContainer}>
                            <Progressbar
                                ...
                                title={t('shipmentmarketplace:Progress')}
                            />
                        </div>
                    )
                    : null}
