...
import InputText from '@modules/configurationshipment/pages/default/components/Input/inputText';
import InputSelect from '@modules/configurationshipment/pages/default/components/Input/inputSelect';
import InputTable from '@modules/configurationshipment/pages/default/components/Input/inputTable';
import InputFile from '@modules/configurationshipment/pages/default/components/Input/inputFile';
import InputMultiSelect from '@modules/configurationshipment/pages/default/components/Input/inputMultiSelect';

const ShipmentConfigurationContent = (props) => {
    const { formik, dataShipment, t } = props;
    ...
    return (
        <>
            <h2 className={classes.titleTop}>{t('shipmentconfiguration:Shipment_Configuration')}</h2>
            <Paper className={classes.container}>
                <div className={classes.content}>
                    {dataShipment?.map((parent, index) => (
                        <Accordion
                    ...
                    <div className={classes.formFieldButton}>
                        <Button className={classes.btn} onClick={formik.handleSubmit} variant="contained">
                            {t('shipmentconfiguration:Submit')}
                        </Button>
                    </div>
                </div>
            </Paper>
...
export default ShipmentConfigurationContent;
