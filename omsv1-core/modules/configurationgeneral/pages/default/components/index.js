...
import useStyles from '@modules/configurationgeneral/pages/default/components/style';
...
import InputText from '@modules/configurationgeneral/pages/default/components/Input/inputText';
import InputSelect from '@modules/configurationgeneral/pages/default/components/Input/inputSelect';
import InputFileImg from '@modules/configurationgeneral/pages/default/components/Input/inputFileImg';
import InputMultiSelect from '@modules/configurationgeneral/pages/default/components/Input/inputMultiSelect';

const GeneralConfigurationContent = (props) => {
    const { formik, dataGeneral, t } = props;
    ...
    return (
        <>
            <h2 className={classes.titleTop}>{t('generalconfiguration:General_Configuration')}</h2>
            <Paper className={classes.container}>
                <div className={classes.content}>
                    {dataGeneral?.map((parent, index) => (
                        <Accordion
