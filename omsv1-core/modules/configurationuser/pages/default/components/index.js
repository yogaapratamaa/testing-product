...
import InputText from '@modules/configurationuser/pages/default/components/inputText';
import InputSelect from '@modules/configurationuser/pages/default/components/inputSelect';

const ConfigUserContent = (props) => {
    const { formik, dataUser, t } = props;
    ...
    return (
        <>
            <h2 className={classes.titleTop}>{t('userconfiguration:User_Configuration')}</h2>
            <Paper className={classes.container}>
                <div className={classes.content}>
                    {dataUser?.map((parent, index) => (
                        <Accordion
...
export default ConfigUserContent;
