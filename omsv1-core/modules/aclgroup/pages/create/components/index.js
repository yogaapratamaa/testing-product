...
import useStyles from '@modules/aclgroup/pages/create/components/style';
...
const AclGroupCreateContent = (props) => {
    ...
    return (
        <>
            ...
            <h2 className={classes.titleTop}>{t('usergroup:Create_User_Group')}</h2>
...
export default AclGroupCreateContent;
