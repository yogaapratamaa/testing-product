...
import useStyles from '@modules/cancelreason/pages/create/components/style';

const CancelReasonCreateContent = (props) => {
    const {
        formik, t,
    } = props;
    ...
    return (
        <>
            ...
            <h2 className={classes.titleTop}>{t('cancelreason:Add_New_Cancel_Reason')}</h2>
...
export default CancelReasonCreateContent;
