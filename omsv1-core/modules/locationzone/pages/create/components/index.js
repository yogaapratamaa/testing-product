...
import useStyles from '@modules/locationzone/pages/create/components/style';

const ZoneCreateContent = (props) => {
    ...
    return (
        <>
            ...
            <h2 className={classes.titleTop}>{t('locationzone:New_Zone')}</h2>
...
export default ZoneCreateContent;
