...
import useStyles from '@modules/prioritylocationbyzone/pages/edit/components/style';

const PriorityZoneEditContent = (props) => {
    ...
    return (
        <>
            ...
            <h2 className={classes.titleTop}>{t('prioritylocationbyzone:Edit_Priority_Location_by_Zone')}</h2>
...
export default PriorityZoneEditContent;
