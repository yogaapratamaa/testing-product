...
const HomeDeliveryImport = (props) => {
    ...
    return (
        <>
            ...
            <h2 className={classes.titleTop}>{t('homedelivery:Bulk_Shipment')}</h2>
            <Paper className={classes.container}>
                <span className={clsx(classes.textAttach, classes.label)}>{t('homedelivery:Attach_File')}</span>
                <div className={classes.content}>
                    <div className={classes.formField}>
                        <div className={classes.label}>
                            <Link href="/shipment/homedelivery/tutorialBulkShipment">
                                <a target="_blank" className={classes.linkDownload}>
                                    {t('homedelivery:Bulk_Shipment_Tutorial')}
                                </a>
                            </Link>
                        </div>
                    </div>
                    <div className={classes.formField} style={{ textAlign: 'left' }}>
                        <DropFile
                            title={t('homedelivery:Please_select_the_file_')}
                            error={(
                                ...
                                ? activityState.error_message
                                    ? (
                                        <div className={clsx(classes.status, 'error')}>
                                            {t('homedelivery:ERROR')}
                                        </div>
                                    )
                                    : (
                                        <div className={clsx(classes.status, 'success')}>
                                            {t('homedelivery:SUCCESS')}
                                        </div>
                                    ) : null}
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell className={classes.rightColumn}>
                                                ...
                                                >
                                                    {activityState.attachment ? t('homedelivery:Download') : '-'}
                                                </a>
                                            </TableCell>
                                        </TableRow>
                                    </TableBody>
