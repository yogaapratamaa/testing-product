...
import useStyles from '@modules/configurationnotification/pages/default/components/style';
...
import InputText from '@modules/configurationnotification/pages/default/components/Input/inputText';
import InputSelect from '@modules/configurationnotification/pages/default/components/Input/inputSelect';

const NotificationConfigurationContent = (props) => {
    const { formik, dataNotification, t } = props;
    ...
    return (
        <>
            <h2 className={classes.titleTop}>{t('notificationconfiguration:Notification_Configuration')}</h2>
            <Paper className={classes.container}>
                <div className={classes.content}>
                    {dataNotification?.map((parent, index) => (
                        <Accordion
                    ...
                    <div className={classes.formFieldButton}>
                        <Button className={classes.btn} onClick={formik.handleSubmit} variant="contained">
                            {t('notificationconfiguration:Submit')}
                        </Button>
                    </div>
                </div>
            </Paper>
